...
public class SQLQueries {
    ...
    public static final String SELECT_VAULT = "SELECT * FROM vaults WHERE id = ?";
    ...
    public static final String SELECT_VAULT_BY_MESSAGE_ID = "SELECT * FROM vaults WHERE id = (SELECT vaultId FROM messages WHERE id = ?)";
